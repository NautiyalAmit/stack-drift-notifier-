...
class DriftDetector(object):
    ...
    def __init__(self,profile="tr-fr-sandbox",region="us-east-1"):
        self.sns_topic = os.environ.get('SNS_TOPIC_ID',None)
        self.sns_subject = os.environ.get('SNS_SUBJECT',"CFN Drift Detector Report")
        self.sns = SNSlogger(self.sns_topic, self.sns_subject, profile="tr-fr-sandbox")
        session = boto3.session.Session(profile_name="tr-fr-sandbox",region_name="us-east-1")
